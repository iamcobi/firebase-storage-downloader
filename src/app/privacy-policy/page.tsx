...
const PrivacyPolicyContent = () => (
  <div className="prose prose-lg mx-auto max-w-3xl lg:prose-xl dark:prose-invert">
    ...
    <p>
      ...
      <br />
      Full name of legal entity: [Your Full Legal Entity Name Here]
      <br />
      Email address: [Your Privacy Contact Email, e.g., privacy@cobiautomation.com]
      <br />
      Postal address: [Your Physical Address Here]
    </p>
